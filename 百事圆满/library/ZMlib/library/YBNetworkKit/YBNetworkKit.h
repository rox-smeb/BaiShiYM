...
#define YB_RESPONSE_BLOCK_ZM(block)                 ZMResponseBlock block = ^(ZMServerResponse *response, id dataOrList)
#define YB_RESPONSE_BLOCK_EX_ZM(block, type)        ZMResponseBlock block = ^(ZMServerResponse *response, type dataOrList)
